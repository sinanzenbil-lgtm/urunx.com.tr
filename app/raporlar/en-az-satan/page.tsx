...
export default function LeastSellingProductsPage() {
    ...
    return (
        <div className="space-y-6 animate-enter pb-16">
            <div className="flex flex-wrap items-start justify-between gap-3">
                <div>
                    <h1 className="text-3xl font-bold tracking-tight">En Az Satan Ürünler</h1>
                ...
                <CardHeader className="space-y-4">
                    <div className="flex items-center justify-between gap-2">
                        <CardTitle className="text-base flex items-center gap-2">
                            ...
                            Tüm En Az Satan Ürünler
                        </CardTitle>
                        <span className="text-sm font-bold text-amber-400">{rows.length} ürün</span>
                    </div>
                                    ...
                                    <tbody className="divide-y divide-zinc-800/70">
                                        {rows.map((row, index) => (
                                            <tr key={row.id} className="hover:bg-zinc-900/50 transition-colors">
                                                ...
                                                <td className="px-3 py-2 text-right font-semibold text-amber-400">{row.qty}</td>
